<!--
   ...
   Date: 4/26/2020
   Purpose: Sets a web page for an online store for a coffee shop. In which case the user can order some coffee.
-->
...
$storeID = "COFFEE";                                                                              /* Sets the variable for $StoreID to COFFEE */
